...
export const __wbg_wasmlogparser_free: (a: number, b: number) => void;
export const wasmlogparser_new: (a: number, b: number) => number;
export const wasmlogparser_parse_logs: (a: number, b: number, c: number, d: number, e: number, f: bigint, g: number, h: number) => any;
export const parse_logs_basic: (a: number, b: number, c: number, d: number) => any;
